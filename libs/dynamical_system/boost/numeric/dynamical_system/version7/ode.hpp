...
/** VERSION WITH EXPRESSION TEMPLATES **************************************/
   ...
   struct Minus { static double _( double a , double b )  {  return  a - b;  } };
   ...
   template < class L , class R >
   Xpression < L , Minus , R >   operator -  ( const L& l , const R &r ) {
      return  Xpression < L , Minus , R >  ( l , r );
   }
   ...
   struct state_t :
      ...
      boost::addable< state_t<T,N> ,
         boost::subtractable< state_t<T,N> ,
            boost::multipliable< state_t<T,N> , double
      > > >
