...
def rossler_all(n_samples=10000, a=0.2, b=0.2, c=5.7, w=1.0, init=[1,0,0]):
   # burster
   # a = 0.38
   # b = 2.
   # c = 50.
...
def rossler(n_samples=10000, init=[1,0,0]):
   return rossler_all(n_samples, init=init)[:,0]

def rossler_funnel(n_samples=10000, init=[1,0,0]):
   return rossler_all(n_samples, a=0.2925, b=0.1, c=8.5, init=init)[:,0]

# ------------------------------------------------------------------------------
# HINDMARSH ROSE NEURON (3 DIMENSIONS)
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
# HINDMARSH ROSE NEURON (4 DIMENSIONS)
# ------------------------------------------------------------------------------
